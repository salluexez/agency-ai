    ...
    <>
      <div className='flex flex-col items-center justify-center text-center px-6 pt-20 pb-10'>
        ...
        <img
          src={assets.bgImage1}
          alt=""
          className="absolute inset-0 min-h-min  w-[83%] object-cover rounded-full -z-10 mt-96 ml-16 md:h-full md:mt-64 md:ml-64 "/>
          <img
          src={assets.bgImage2}
          alt=""
          className="absolute inset-0 min-h-min  w-[83%] object-cover rounded-full -z-10 mt-80 ml-16 md:h-full md:mt-[999px] md:ml-0 "/>
